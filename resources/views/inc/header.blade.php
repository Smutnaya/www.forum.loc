<header><nav class="navbar navbar-expand-md d-none d-sm-none d-md-block fs-5">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="mx-2 ms-3">
                <img class="min-avatar" alt="avatar" src="https://avatarko.ru/img/avatar/2/kot_multfilm_ochki_1332.jpg">
                Пользователь
            </div>
        </div>
    </div>
...
<nav class="navbar navbar-expand-md d-sm-block d-sx-block d-lx-none d-lg-none d-md-none py-0">
    <div class="container-fluid gx-0 ">
            <div class="text-start col-12 col-sm-7">
                <button class="btn btn-sm text-start py-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
                    aria-controls="offcanvasTop">
                    <h5 id="offcanvasTopLabel">
                        <img class="min-logo" src="/images/vs logo.png"><span class="ps-3">Форум игры Времена Смуты </span></h5>
                  </button>
                </div>
            <div class="text-end my-1 col-12 col-sm-5">
                <img class="min-avatar-mob mx-2" alt="avatar" src="https://avatarko.ru/img/avatar/2/kot_multfilm_ochki_1332.jpg">
                Пользователь
        ...
        <div class="offcanvas offcanvas-top g-0 p-0" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
            ...
            <div class="offcanvas-body py-3" style="background:#f8f3eb;">
              <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="py-1" aria-current="page" href=#>Форумы</a>
                </li>
                <li class="nav-item">
