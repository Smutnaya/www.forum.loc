<div class="accordion accordion-flush d-block d-md-none" id="accordionFlushExample">
    <div class="accordion-item" style="background:#f1e9c2; color:#050505;">
        <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button collapsed fs-6 pt-0 pb-1" type="button"
                style="background:#f1e9c2; color:#050505;" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne"
