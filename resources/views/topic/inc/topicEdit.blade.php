                        ...
                        <div class="my-3">
                            ...
                            @if ($model['user']['role_id'] > 1 || $model['moder'])
                                ...
                                <div class="btn-group col-12 mb-3 new-tema" role="group" aria-label="Basic checkbox toggle button group" style="height: 25px !important">
                                    ...
                                    <input type="checkbox" class="btn-check" name="check[]" id="btncheck3" autocomplete="off" value="hide" @if ($model['topic']['hide'] == 1) checked @endif @if ($model['forum']['hide'] == 1) checked disabled @endif>
                                    ...
                                    <input type="checkbox" class="btn-check" name="check[]" id="btncheck4" autocomplete="off" value="moder" @if ($model['topic']['moderation'] == 1) checked @endif @if ($model['forum']['moderation'] == 1) checked  disabled @endif>
